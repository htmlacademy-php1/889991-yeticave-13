...
<ul class="pagination-list">
    ...
    <li class="pagination-item pagination-item-prev">
        <a <?php if ($cur_page >= 2): ?> href="all-lots.php?category_id=<?= $cat; ?>&page=<?= $prev; ?>"<?php endif; ?>>Назад</a>
    </li>
    <?php foreach($pages as $page): ?>
        ...
        <li class="pagination-item pagination-item-next">
            <a <?php if ($cur_page < $pages_count): ?> href="all-lots.php?category_id=<?= $cat; ?>&page=<?= $next; ?>"<?php endif; ?>>Вперед</a>
        </li>
    </ul>
<?php endif; ?>
    </div>
